...
THIS IS ALTERNATED VERSION!THIS IS ALTERNATED VERSION!
THIS IS ALTERNATED VERSION!THIS IS ALTERNATED VERSION!THIS IS ALTERNATED VERSION!
THIS IS ALTERNATED VERSION!
*
...
// BUT ALL FUCKIN COMPUTATIONS ARE IN ROW MAJOR! AND YOU MUST USE CONVERTER FUNCTION FOR THAT!!! :(((
...
RMAPI float MatrixDeterminant(Matrix mat) {
	...
	result = a30 * a21 * a12 * a03 - a20 * a31 * a12 * a03 - a30 * a11 * a22 * a03 + a10 * a31 * a22 * a03 + a20 * a11 * a32 * a03 -
					 a10 * a21 * a32 * a03 - a30 * a21 * a02 * a13 + a20 * a31 * a02 * a13 + a30 * a01 * a22 * a13 - a00 * a31 * a22 * a13 -
					 a20 * a01 * a32 * a13 + a00 * a21 * a32 * a13 + a30 * a11 * a02 * a23 - a10 * a31 * a02 * a23 - a30 * a01 * a12 * a23 +
					 a00 * a31 * a12 * a23 + a10 * a01 * a32 * a23 - a00 * a11 * a32 * a23 - a20 * a11 * a02 * a33 + a10 * a21 * a02 * a33 +
...
RMAPI Matrix GetCameraMatrix2D(float tx, float ty, float rot, float zoom, float ox, float oy) {
    Matrix matTransform = { };
    ...
    //   2. Rotate and Scale
    //   3. Move by -target
    Matrix matOrigin = MatrixTranslate(-tx, -ty, 0.0f);
    Matrix matRotation = MatrixRotate((Vector3){ 0.0f, 0.0f, 1.0f }, rot*DEG2RAD);
    Matrix matScale = MatrixScale(zoom, zoom, 1.0f);
    Matrix matTranslation = MatrixTranslate(ox, oy, 0.0f);
