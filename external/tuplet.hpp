...
#define TUPLET_FWD_M(TupleType, BaseType, tup, value) static_cast<::tuplet::forward_as_t<TupleType&&, BaseType>>(tup).value
/// Gets a member in a tuple via the base class
#define TUPLET_GET_M(BaseType, tup, value) tup.::tuplet::identity_t<BaseType>::value
#elif __clang__
/// Looks up a member in a tuple via the base class, and forwards it
#define TUPLET_FWD_M(TupleType, BaseType, tup, value) static_cast<TupleType&&>(tup).::tuplet::identity_t<BaseType>::value
#define TUPLET_GET_M(BaseType, tup, value) tup.::tuplet::identity_t<BaseType>::value
#else
/// Looks up a member in a tuple via the base class, and forwards it
...
#ifdef _MSC_VER
	[&](auto&... v1) -> bool {
		return [&](auto&... v2) -> bool { return (_partial_cmp(v1, v2, is_less) && ...); }(TUPLET_GET_M(B1, t2, value)...);
	}(TUPLET_GET_M(B1, t1, value)...);
#else
...
#ifdef _MSC_VER
	[&](auto&... v1) -> bool {
		return [&](auto&... v2) -> bool { return (_partial_cmp(v1, v2, is_less) && ...); }(TUPLET_GET_M(B2, t2, value)...);
	}(TUPLET_GET_M(B1, t1, value)...);
#else
...
#else
	TUPLET_INLINE constexpr auto operator==(type_map const& other) const { return detail::_equals(*this, other, base_list{}); }
	TUPLET_INLINE constexpr auto operator!=(type_map const& other) const { return !(*this == other); }
	TUPLET_INLINE constexpr auto operator<(type_map const& other) const { return detail::_less(*this, other, base_list{}); }
	TUPLET_INLINE constexpr auto operator<=(type_map const& other) const { return detail::_less_eq(*this, other, base_list{}); }
	TUPLET_INLINE constexpr auto operator>(type_map const& other) const { return detail::_less(other, *this, base_list{}); }
	TUPLET_INLINE constexpr auto operator>=(type_map const& other) const { return detail::_less_eq(other, *this, base_list{}); }
#endif
};
}	 // namespace tuplet
...
#ifdef _MSC_VER
	return [&](auto&&... v1) -> bool { return (bool(func(static_cast<decltype(v1)&&>(v1))) || ...); }(TUPLET_FWD_M(Tup, B, tup, value)...);
#else
...
struct tuple : tuple_base_t<T...> {
	...
	TUPLET_INLINE bool operator>=(tuple const&) const = default;
#else
	TUPLET_INLINE constexpr auto operator==(tuple const& other) const { return detail::_equals(*this, other, base_list{}); }
	TUPLET_INLINE constexpr auto operator!=(tuple const& other) const { return !(*this == other); }
	TUPLET_INLINE constexpr auto operator<(tuple const& other) const { return detail::_less(*this, other, base_list{}); }
	TUPLET_INLINE constexpr auto operator<=(tuple const& other) const { return detail::_less_eq(*this, other, base_list{}); }
	TUPLET_INLINE constexpr auto operator>(tuple const& other) const { return detail::_less(other, *this, base_list{}); }
	TUPLET_INLINE constexpr auto operator>=(tuple const& other) const { return detail::_less_eq(other, *this, base_list{}); }
#endif
	template <class... U>
...
struct pair {
...
#else
	TUPLET_INLINE constexpr bool operator==(pair const& other) const { return first == other.first && second == other.second; }
	...
	TUPLET_INLINE constexpr bool operator<=(pair const& other) const {
		bool result = false;
		bool is_eq = detail::_partial_cmp(first, other.first, result) && detail::_partial_cmp(second, other.second, result);
		return result || is_eq;
	}
	TUPLET_INLINE constexpr bool operator>(pair const& other) const {
		bool result = false;
	...
	TUPLET_INLINE constexpr bool operator>=(pair const& other) const {
		bool result = false;
		bool is_eq = detail::_partial_cmp(other.first, first, result) && detail::_partial_cmp(other.second, second, result);
		return result || is_eq;
	}
#endif
};
